                            ...
                            <div class="swiper-container main-slider">
                                <div class="swiper-wrapper">
                                    ...
                                    @foreach (explode(',', $product->images ?? '') as $imageFile)
                                        ...
                                        @if (!empty($imageFile))
                                            <div class="swiper-slide product-single__image-item">
                                                <img src="{{ asset('uploads/product/' . $imageFile) }}" width="674"
                                                    height="550" />
                                                <a data-fancybox="gallery"
                                                    href="{{ asset('uploads/product/' . $imageFile) }}" title="Zoom">
                                                    <svg width="16" height="16">
                                                        <use href="#icon_zoom" />
                                                    </svg>
                                                </a>
                                ...
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide product-single__image-item">
                                        <img loading="lazy" class="h-auto"
                                            src="{{ asset('uploads/product/' . $product->image) }}" width="104"
                                    ...
                                    @foreach (explode(',', $product->images ?? '') as $imageFile)
                                        ...
                                        @if (!empty($imageFile))
                                            <div class="swiper-slide product-single__image-item">
                                                <img loading="lazy" class="h-auto"
                                                    src="{{ asset('uploads/product/' . $imageFile) }}" width="104"
                                                    height="104" alt="{{ $product->name }}" />
                                            </div>
                                        @endif
                                    @endforeach
                ...
                <div class="col-lg-5">
                    ...
                    <div class="product-single__addtolinks">
                        @if (session()->has('wishlist') && array_key_exists($product->id, session('wishlist')))
                            <form method="POST" action="{{ route('wishlist.remove', ['id' => $product->id]) }}"
                                ...
                                <a href="javascript:void(0)"
                                    class="menu-link menu-link_us-s add-to-wishlist filled-heart" style="color:orange;"
                                    onclick="document.getElementById('remove-wishlist-frm').submit();">
                        ...
                        <share-button class="share-button">
                            ...
                            <detailpages id="detailpages-share-template__main" class="m-1 xl:m-1.5" hidden="">
