                              ...
                              <div class="slide-split h-100 d-block d-md-flex overflow-hidden">
                                  ...
                                  <div class="slide-split_media position-relative">
                                      <div class="slideshow-bg" style="background-color: #f5e6e0;">
                                          <img loading="lazy" src="images/shop/shop_banner3.jpg" width="630"
                              ...
                              <div class="product-card mb-3 mb-md-4 mb-xxl-5">
                                      ...
                                      <div class="swiper-container background-img js-swiper-slider"
                                          ...
                                          <div class="swiper-wrapper">
                                              <div class="swiper-slide">
                                                  ...
                                                  <a href="{{ route('detailpage', ['product_slug' => $product->slug]) }}"><img
                                                          loading="lazy"
                                  ...
                                  <div class="pc__info position-relative">
                                      ...
                                      <form method="POST" action="{{ route('wishlist.remove', ['id' => $product->id]) }}">
                                        @csrf
                                        @method('DELETE')
                                          <button class="pc__btn-wl position-absolute top-0 end-0 bg-transparent border-0" style="color:orange;"
