                          ...
                          @foreach ($categories as $category)
                              <div class="swiper-slide">
                                  <img loading="lazy" class="w-100 h-auto mb-3"
                                      ...
                                      alt="{{ $category->name }}" width="124" height="124" alt="" />
                                  <div class="text-center">
                                      <a href="{{route('shop',['categories' =>$category->id])}}" class="menu-link fw-medium">{{ $category->name }}</a>
                                  </div>
                              </div>
                          @endforeach
                      </div>
              ...
              <div class="row">
                  <div class="col-md-6">
                      <div class="category-banner__item border-radius-10 mb-5">
                          <img loading="lazy" class="h-auto" src="images/home/demo3/category_9.jpg" width="690"
                              height="665" alt="" />
                  ...
                  <div class="col-md-6">
                      <div class="category-banner__item border-radius-10 mb-5">
                          <img loading="lazy" class="h-auto" src="images/home/demo3/category_10.jpg" width="690"
                              height="665" alt="" />
                          <div class="category-banner__item-mark">
                              Starting at $19
                          </div>
